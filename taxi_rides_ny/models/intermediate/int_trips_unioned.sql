-- mientras que source se usa para usar los datos que se indican en sources.yml (puede tener otro nombre)
-- ref se usa para hacer referencia a otros modelos, en este caso al modelo stg_green_tripdata
